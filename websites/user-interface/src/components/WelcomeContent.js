    ...
    <div className="max-w-6xl mx-auto px-6 py-16 text-gray-900 dark:text-white overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-md p-8 
          border border-gray-100 dark:border-gray-700 transform-gpu"
        >
          <motion.div variants={floatingAnimation} initial="initial" animate="animate" className="mb-6">
            <motion.div
              whileHover="hover"
        ...
        >
          ...
          <div
            className="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-pink-500 to-red-500 
            transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-out"
          />
        </motion.div>
      </motion.div>
