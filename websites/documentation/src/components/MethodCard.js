...
import CodeBlock from './CodeBlock';  // Assuming you have a CodeBlock component to display code snippets
    ...
    <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
      ...
      {isOpen && (
        <div className="mt-4">
          ...
          <CodeBlock language="python" code={example} />  {/* Ensure CodeBlock handles syntax highlighting */}
        </div>
      )}
    </div>
  );
